...
<section class="contact" id="contact">
    ...
    <h1 class="heading"><span>Ajouter une auto  </span> </h1>

    <div class="row">

    <form action="actionAjAuto.php" method="POST">
     
            <input type="text" name="noserie"  placeholder="Numero de série" class="box">
            <input type="text" name="marque"  placeholder="Marque" class="box">
            <input type="text" name="modele"  placeholder="Modèle" class="box">
            <input type="text" name="disponibilite"  placeholder="Nombres des voitures disponibles de cette marque" class="box">
            <input type="number" name="prix"  placeholder="Prix" class="box">
            <input type="file" name="photo" class="box">
            <input type="submit" name="ajouterAuto" value="Ajouter une voiture" class="btn">
        </form>
