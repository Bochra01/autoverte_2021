...
<section class="contact" id="contact">
    ...
    <h1 class="heading"><span>Supprimer des élèments</span> </h1>
    <div class="row">

    <form action="suppAuto.php" method="POST">
     
            <input type="text" name="noserie"  placeholder="Numero de série de la voiture" class="box">           
            <input type="submit" name="suppAuto" value="Supprimer une voiture" class="btn">
        </form>
...
<section class="contact" id="contact">
    ...
    <form action="suppClient.php" method="POST">    
            ...
            <input type="submit" name="suppClient" value="Supprimer un client" class="btn">
        </form>
...
<section class="contact" id="contact">
    ...
    <form action="suppLocation.php" method="POST">
     
            <input type="text" name="noserie"  placeholder="Numero de série de la voiture" class="box">           
            <input type="submit" name="suppLocation" value="Supprimer une location" class="btn">
        </form>
