...
<section class="contact" id="contact">
    ...
    <h1 class="heading"><span>Ajouter une location une voiture</span> </h1>

    <div class="row">

    <form action="actionAjLocation.php" method="POST">
     
            <input type="text" name="code"  placeholder="Code du client" class="box">
            <input type="text" name="noserie"  placeholder="Numero de serie " class="box">
            <input type="date" name="datelocation"  placeholder="Date de location" class="box">
            <input type="date" name="dateretour"  placeholder="date de retour" class="box">
            <input type="number" name="prix"  placeholder="Prix de location" class="box">
            <input type="submit" name="ajouterLocation" value="Ajouter une location" class="btn">
        </form>
